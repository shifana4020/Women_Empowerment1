...
try {
  ...
  //  $mail->addCC('cc@example.com');
   ...
   /// $mail->addAttachment('/var/tmp/file.tar.gz');         //Add attachments
    ...
    $mail->Body    ='You are now a lawyer at Women Empowerment!! <br> Username : '.$eemail.' <br> Password :'.$pass;
    $mail->AltBody = 'Thanks For your Interest';

    $mail->send();
    
    echo "<script>alert('Message has been Sent');window.location.href='../admin/addcounsellor.php';</script>";
