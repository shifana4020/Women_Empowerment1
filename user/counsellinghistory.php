...
$res1=mysqli_query($con,$sql);?>
				...
				<!-- <th>Comments From Counsellor</th>
			    <th>Comment Date</th> -->
				<!-- <th>Feedback</th></tr> -->
<?php
...
// while($k=mysqli_fetch_array($res12))
// {
?>
<tr>
<td><?php echo $r['fromdate'];?></td><td><textarea  disabled="disabled" ><?php echo $r['message'];?></textarea></td>
<td><textarea disabled="disabled"><?php echo $j['status'];?></textarea></td>
<td><a href="historycounselling.php?id=<?php echo $id ?>&did=<?php echo $r[0]; ?>&&if=<?php echo $if ?>"style="border: none; color:green;"><i></i>View Comments</a></td>
<!-- <td><textarea disabled="disabled"><?php echo $k['comments'];?></textarea></td>
<td><textarea disabled="disabled"><?php echo $k['cmdate'];?></textarea></td> -->
<?php
}
//}
?>

<!-- <td><a href="viewlprofile.php?did=<?php echo $r['bookid'];?>">Lawyer Profile</a></td> -->
<!-- <td><a href="feedbackcase.php?did=<?php echo $r['bookid'];?>">feedback</a></td></tr> -->
</table>
					</div>
				</div>
