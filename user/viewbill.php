...
<!-- mail -->
	<div class="mail">
			<h3><span>Case Service Charge</span> </h3>
			<div class="mail-grids">
				<div class="table table-bordered table-striped">
					<div class="mail-grid-left1">
					<?php
include '../connect.php';
 $sql="select * from crimedetails where logid=$id and status='Unpaid'";
...
<td><textarea disabled="disabled"><?php echo $r['status'];?></textarea></td><td><textarea disabled="disabled"><?php echo $r['charge'];?></textarea></td>
<td></button><button><a href="paymentprocess.php">Pay Now</a></button></td>
<!-- <form method="POST" action="orderaction.php?amount=<?php echo $amount; ?>&&ar=<?php echo $ar; ?>"> -->
</tr>
<?php
}
?></table>
