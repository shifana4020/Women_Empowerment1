...
$session=$_SESSION['id'];
$amount=1000;
$sqlii="SELECT tbl_reg.loginid,tbl_reg.name,tbl_reg.phone,tbl_reg.email,tbl_reg.address,tbl_reg.id,bookdetails.bookid,bookdetails.charge,bookdetails.logid from bookdetails join tbl_reg on bookdetails.logid=tbl_reg.loginid where tbl_reg.loginid='$session'";
...
while ($rows = mysqli_fetch_array($result)) {
 ...
 $sr="SELECT charge FROM bookdetails where bookdetails.logid='$session'";
...
<form method="POST" action="paymentc.php?amount=<?php echo $amount; ?>&&ar=<?php echo $ar; ?>">
<script
