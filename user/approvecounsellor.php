...
<td><textarea disabled="disabled"><?php echo $j['comments'];?></textarea></td>
<td><textarea disabled="disabled"><?php echo $j['cmdate'];?></textarea></td>
<td><a href="viewcprofile.php?did=<?php echo $r['bookid'];?>">Counsellor Profile</a></td>
<td><a href="feedbackcounselling.php?did=<?php echo $r['bookid'];?>&&if=<?php echo $if ?>">feedback</a></td></tr>
<?php
}
?></table>
					</div>
