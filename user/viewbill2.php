		...
		<div class="container">
			...
			<div class="mail-grids">
				<div class="table table-bordered table-striped">
					...
					<?php
include '../connect.php';
 $sql="select * from bookdetails where logid=$id and status='Unpaid'";
...
<td><textarea disabled="disabled"><?php echo $r['status'];?></textarea></td>
<td><textarea disabled="disabled"><?php echo $r['charge'];?></textarea></td>
<td><button><a href="paymentprocesscounsel.php">Pay Now</a></button></td></tr>
<?php
}
?></table>
					</div>
