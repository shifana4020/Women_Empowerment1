...
$if=$_GET['if'];
$sql2="select * from backup where a_id='$if'";
...
<td><textarea disabled="disabled"><?php echo $k['comment'];?></textarea></td>
<td><textarea disabled="disabled"><?php echo $k['commentdate'];?></textarea></td>
<!-- <td><a href="historyuser.php?id=<?php echo $id ?>&did=<?php echo $r[0]; ?>&&if=<?php echo $if ?>"style="border: none; color:green;"><i></i>View Comments</a></td> -->
</tr>
<?php
//}
}
...
<!-- <td><a href="viewlprofile.php?did=<?php echo $r['detailid'];?>">Lawyer Profile</a></td> -->
<!-- <td><a href="feedbackcase.php?did=<?php echo $r['detailid'];?>">feedback</a></td></tr> -->
</table>
					</div>
				</div>
