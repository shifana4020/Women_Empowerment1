...
$result1=mysqli_query($con,"SELECT `charge`,`fromdate`,`status` FROM `bookdetails` where bookid=$did") or die(mysqli_error($con));
...
$pdf->Cell(50,13,'Apply Date : '. $row1['fromdate'],0,1);
