...
$if=$_GET['if'];
$sqe="select * from assigncase where detailid=$did and $if";
$ree=mysqli_query($con,$sqe);
while($k=mysqli_fetch_array($ree))
{

?>
<form action="casefeedback.php?did=<?php echo $did ?>&&if=<?php echo $if ?>" method="post">
<input type="Hidden" name="iddd" value="<?php echo $did ?>" >	
<!-- <input type="hidden" name="cid" value="<?php echo $cid;?>"> -->
<tr>
<!-- <td><?php echo $r['crimedate'];?></td><td><textarea  disabled="disabled" ><?php echo $r['discription'];?></textarea></td><td> <?php echo $k['status'];?></td> -->
    ...
    var val = document.getElementById('feedback').value;
	 if(val=="")
	 {
		...
		return false;
				...
				<button type="button"><a href="viewcases.php">Cancel</button>
										</td>
</tr>
