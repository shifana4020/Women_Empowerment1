...
<!-- mail -->
	<div class="mail">
		<div class="container">
			<h3><span>View Rjected slots</span> </h3>
			...
			<div class="mail-grids">
				<div class="col-md-6 mail-grid-left">
					...
					<?php
include '../connect.php';
 $sql="select * from bookdetails where logid=$id and status='Rejected'";
...
{
$did=$r['bookid'];
$sql1="select * from bookdetails where bookid=$did";
...
<tr><td><textarea  disabled="disabled" ><?php echo $r['message'];?></textarea></td>
<td><textarea disabled="disabled"><?php echo $j['status'];?></textarea></td>
<td><textarea disabled="disabled"><?php echo $j['reason'];?></textarea></td>
</tr>
<?php
}
?></table>
