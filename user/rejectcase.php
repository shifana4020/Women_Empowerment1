...
<!-- mail -->
	<div class="mail">
		<div class="container">
			<h3><span>Rejected Cases</span> </h3>
...
<tr>
	...
	<td><textarea  disabled="disabled" ><?php echo $r['discription'];?></textarea></td>
<td><textarea disabled="disabled"><?php echo $j['status'];?></textarea></td>
<td><textarea disabled="disabled"><?php echo $j['reason'];?></textarea></td></tr>
<?php
}
?></table>
					</div>
