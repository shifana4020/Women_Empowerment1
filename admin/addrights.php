...
<form action="" method="post" name="form7" enctype="multipart/form-data">
            ...
            <!-- main-heading -->
           <h2 class="main-title-w3layouts mb-2 text-center text-blue">Women Rights</h2>
            <!--// main-heading -->
            <div class="form-body-w3-agile text-center w-lg-50 w-sm-75 w-100 mx-auto mt-5">
                <form  method="post" enctype="multipart/form-data">
                    <div class="form-group">
					<span class="lnr lnr-user"></span>
                        <label>Women Right</label>
...
$s1 = "SELECT * FROM rights WHERE name = '$name'";
    $result1 = mysqli_query($con, $s1);
    $row1=mysqli_fetch_assoc($result1);
    $uname= isset($row1['name']) ? $row1['name'] : '';
	if ($uname!="") 
            {
            echo "<script>alert('this right is already exist'); window.location.href='addrights.php';</script>";
            }
            else
			{
$sql1="insert into rights(name,file,status) values('$name','$file','active')";
$result = mysqli_query($con, $sql1);
}
echo "<script>alert('Right added'); window.location.href='addrights.php';</script>";
}
?>
