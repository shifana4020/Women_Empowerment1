...
<body>
  ...
  <div class="outer-w3-agile mt-2">
                    <h2 class="tittle-w3-agileits mb-4">View Lawyers</h2>
...
include '../connect.php';
$sql3="select * from lawyers WHERE status=1";
...
$r1q=mysqli_fetch_array($res1q);
    ...
    <td><?php echo $r['name'];?><br>
     ...
     <td><?php echo $r1['categorylawyer'];?></td>
	 <td><?php echo $r['experiencedyears'];?></td>
                <td><a style="color:#F63" href="deletelawyers.php?id=<?php echo $r['loginid'];?>"><b>Blocked</a></td></tr>
                      <?php
}
?></tbody>
                    </table>
...
<div class="outer-w3-agile mt-2">
                    <h2 class="tittle-w3-agileits mb-4">View Blocked Lawyers</h2>
                    <table class="table table-bordered table-striped" width="700">
                        <thead>
                            <tr>
                            <th>Name,<br>
...
include '../connect.php';
$sql3="select * from lawyers WHERE status=0";
$res = mysqli_query($con,$sql3);
//$r = mysqli_fetch_assoc($res);
while($r=mysqli_fetch_array($res))
{
...
$r1q=mysqli_fetch_array($res1q);
    ?>
     ...
     <td><?php echo $r1['categorylawyer'];?></td>
	 <td><?php echo $r['experiencedyears'];?></td>
                <td><a style="color:#F63" href="unblocklawyers.php?id=<?php echo $r['loginid'];?>"><b>Unblocked</a></td></tr>
                      <?php
}
?></tbody>
                    </table>
