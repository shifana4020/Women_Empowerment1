...
?>
            ...
            <section class="grids-section bd-content">
                ...
                <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">Total cases details</h4>
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                          ...
                          <?php
                          include '../connect.php';
$sql="select * from crimedetails where  status='Aproved' & 'Rejected'";
...
?>
        ...
        <b>Address:</b><?php echo $r1['address'];?><br /><b>Email:</b><?php echo $r1['email'];?><br><b>Ph no:</b><?php echo $r1['phone'];?><br><b>State:</b><?php echo $r1s['sname'];?><br />
