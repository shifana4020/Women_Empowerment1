...
?>
		...
		<b>District:</b><?php echo $r1q['dname'];?><br /><b>Dob:</b><?php echo $r1['dob'];?></td><td><img src="../uploads/<?php echo $r['idproof'];?>" width="100" height="100" /></td>
		...
		<b>Complaint:</b><?php echo $r['discription'];?><br /><b>Crime Date on: </b><?php echo $r['crimedate'];?><br><b>Applied Date: </b><?php echo $r['applydate'];?></td>
        		...
        		<td><a href="servicechargecrime.php?id=<?php echo $id; ?>&did=<?php echo $r[0]; ?>"style="border: none; color:green;"><i class="fa fa-check-square"></i></a></td>
                <td><a href="reason.php?id=<?php echo $r[0];?>"style="border: none; color:red;"><i class="fa fa-times"></i></a></td>
				</tr>
                      <?php
}
?>
