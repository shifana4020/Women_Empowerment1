...
?>
            ...
            <section class="grids-section bd-content">
                ...
                <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">Total Booking Details</h4>
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                          ...
                          <?php
                          include '../connect.php';
$sql="select * from bookdetails where  status='Approved' & 'Rejected'";
...
?>
        ...
        <b>Message:</b><?php echo $r['message'];?><br /><br> on <?php echo $r['fromdate'];?></td>
