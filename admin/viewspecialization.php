...
<body>
  ...
  <div class="outer-w3-agile mt-2">
                    <h2 class="tittle-w3-agileits mb-4">View Specializations</h2>
...
include '../connect.php';
$sql1="select * from specification_tbl where status='active'";
...
while($r=mysqli_fetch_array($res1))
{
	...
	<tr>
     ...
     <td><a style="color:red" href="deletespecialization.php?id=<?php echo $r['spec_id'];?>"><b>Inactive</a></td></tr>
                      <?php
}
?></tbody>
                    </table>
