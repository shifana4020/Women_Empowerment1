...
?>
            ...
            <section class="grids-section bd-content">
                ...
                <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">Total Counsellors Leave</h4>
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                          ...
                          <?php
                          include '../connect.php';
$sql="select * from leave_cc where  status='Accepted' & 'Rejected'";
...
?>
		<tr><td><b>Name:</b><?php echo $r1['name'];?><br><b>Age:</b><?php echo $r1['age'];?><br><b>Gender:</b><?php echo $r1['gender'];?><br>
        <b>Ph no:</b><?php echo $r1['phonenumber'];?><br><b>Email:</b><?php echo $r1['email'];?><br>
        <b>Address:</b><?php echo $r1['address'];?><br><b>State:</b><?php echo $r1s['sname'];?>
        <b>District:</b><?php echo $r1q['dname'];?></td>
