...
if (! empty($_SESSION['logged_in'])) {
    ...
    $sql="select *from `awarenessprograms` where programid='$programid'";
   ...
   // $officer_password = $_POST['password'];
        ...
        mysqli_query($con,"UPDATE `awarenessprograms` SET 
        `programid`='$programid',`programname`='$programname',`date`='$date',`name`='$name',`discription`='$discription' where programid='$programid'");
    
            echo "<script>alert('Updated');</script>";
            header('location: viewawarenessprograms.php');
     }
 ?>
 <?php
include("header.php");
...
<div class="container">
  ...
  <div class="modal-header">
					 ...
					 <div class="form-group">
                        <label for="company" class=" form-control-label"> program Name</label>
                   <input type="text"   class="form-control" name="programname"  id="programname"  onfocusout="f1()" value="<?php echo $programname?>">
                </div>
				<div class="form-group">
