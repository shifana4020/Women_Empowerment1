...
<section class="grids-section bd-content">
                    ...
                    <h2 class="tittle-w3-agileits mb-4">View Awarenessprograms</h2>
...
{?>
        ...
        <td><img src="../uploads/<?php echo $r['file'];?>" width="100" height="100"></td>
		 <td><a style="color:blue" href="editprograms.php?programid=<?php echo $r['programid'];?>"><b>Update</a></td>
                <td><a style="color:red"href="deleteprograms.php?id=<?php echo $r['programid'];?>"><b>Inactive</a></td></tr>
                      <?php
}
?></tbody>
                    </table>
                ...
                <div class="outer-w3-agile mt-2">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                          ...
                          <?php
						include '../connect.php';
$sql="select * from awarenessprograms  WHERE status='inactive'";
$result = mysqli_query($con, $sql);
//$r= mysqli_fetch_assoc($result);
while($r=mysqli_fetch_array($result))
{?>
        ...
        <td><?php echo $r['discription'];?></td>
        <td><img src="../uploads/<?php echo $r['file'];?>" width="100" height="100"></td>
                <td><a style="color:red"href="activeprograms.php?id=<?php echo $r['programid'];?>"><b>active</a></td></tr>
                      <?php
}
?></tbody>
                    </table>
