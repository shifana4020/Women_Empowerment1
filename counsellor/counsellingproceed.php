...
<body>
          ...
          <div class="col-lg-8">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-dark bg-transparent justify-content-center py-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Counselling Updation</li>
              </ol>
            </nav>
            <h1 class="fg-white text-center">Counselling Updation</h1>
          </div>
        </div>
      </div>
    </div> <!-- .page-banner -->
  ...
  <main>
            ...
            <section class="grids-section bd-content">
                ...
                <br><h3 class="tittle-w3-agileits mb-4" align="center"><b>proceed Counselling Updation Details</b></h3>
                    <table class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th>View Updated comment</th>
								                 <th>Comment to user</th>
                                <th>Comment Update Date</th>
                                <!-- <th>Case Action</th> -->
								                 <th>Counselling Updation</th>
                                <!-- <th>Action</th> -->
...
<td><textarea name="comments" id="comments" rows="7" cols="40" placeholder="Type your comments.."></textarea></td>
...
<!-- <td><a href="approvecomment.php?id=<?php echo $r1[9];?>&id=<?php echo $r[0]; ?>"style="border: none; color:green;"><i class="fa fa-check-square"></i></a>
                ...
                <td> <?php echo $k['cmdate'];?></td>
				<td><input type="submit" name="update" value="SEND TO USER" style="background-color:cream">
										</td>
                                        <!-- <td><button><a style="color:black"  href="rejectcomment.php?id=<?php echo $r[0];?>"style="border: none; color:green;">Terminate Case</a></button></td>
                                         <td><input type="submit" name="complete" value="COMPLETE" style="background-color:#FF99FF">
										</td> -->
...
$did=$_POST['iddd'];
$sta=$_POST['comments'];
$ss="INSERT INTO `counselbackup`(`a_id`, `comments`, `cmdate`) VALUES ('$iid','$comment','$datee')";
$rr=mysqli_query($con,$ss);
$sql="UPDATE `assigncounsel` SET `status`='Proceed',`comments`='$sta', cmdate='$d' where bookid='$did'";
$r=mysqli_query($con,$sql);
echo "<script>alert('update comments...')-</script>";
echo "<script>window.location='counsellingproceed.php'</script>";
...
window.location='caseproceed.php';
</script> -->